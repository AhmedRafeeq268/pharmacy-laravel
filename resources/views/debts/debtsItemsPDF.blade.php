...
<head>
    <meta charset="UTF-8">
    <title>@lang('messages.reports.debts_report')</title>
    <style>
        @font-face {
        font-family: 'Amiri';
...
<body>
    ...
    <h2>@lang('messages.reports.debts_report')</h2>
    ...
    <table>
        <thead>
            <tr>
                <th>#</th>
                <th>@lang('messages.debts.customer_name')</th>
                <th>@lang('messages.customer.phone_number')</th>
                <th>@lang('messages.customer.address')</th>
                <th>@lang('messages.debts.total_amount')</th>
                <th>@lang('messages.debts.total_remaining')</th>
                <th>@lang('messages.created_at')</th>
            </tr>
        </thead>
        <tbody>
            @php $id = 1; @endphp
            @foreach($debtsItems as $item)
                <tr>
                    <td>{{ $id++ }}</td>
