...
<head>
    <meta charset="UTF-8">
    <title>@lang('messages.reports.damaged_items_report')</title>
    <style>
        @font-face {
            font-family: 'Cairo';
...
<body>
    ...
    <h2>@lang('messages.reports.damaged_items_report')</h2>

    <table>
        <thead>
            <tr>
                <th>#</th>
                <th>@lang('messages.damaged.prodact_name')</th>
                <th>@lang('messages.damaged.damaged_quantity')</th>
                <th>@lang('messages.damaged.cost')</th>
                <th>@lang('messages.damaged.reported_by')</th>
