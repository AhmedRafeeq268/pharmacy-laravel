...
<head>
    <meta charset="UTF-8">
    <title>@lang('messages.reports.product_report')</title>
    <style>
        @font-face {
        font-family: 'Amiri';
...
<body>
    ...
    <h2>@lang('messages.reports.product_report')</h2>
    ...
    <table>
        <thead>
            <tr>
                ...
                <th>@lang('messages.product.manufacturer')</th>
                <th>@lang('messages.product.product_category')</th>
                <th>@lang('messages.product.unit_price')</th>
