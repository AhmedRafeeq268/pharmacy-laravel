...
<head>
    <meta charset="UTF-8">
    <title>@lang('messages.reports.salesReturn_report')</title>
    <style>
        @font-face {
        font-family: 'Amiri';
...
<body>
    ...
    <h2>@lang('messages.reports.salesReturn_report')</h2>

    <table>
        <thead>
            <tr>
                <th>#</th>
                <th>@lang('messages.salesReturn.pos_bill_number')</th>
                <th>@lang('messages.salesReturn.customer_name')</th>
                <th>@lang('messages.salesReturn.total')</th>
                <th>@lang('messages.salesReturn.refund_method')</th>
                <th>@lang('messages.salesReturn.product_name')</th>
                <th>@lang('messages.salesReturn.price')</th>
                <th>@lang('messages.salesReturn.quantity')</th>
                <th>@lang('messages.salesReturn.subtotal')</th>
                <th>@lang('messages.created_at')</th>
            </tr>
        </thead>
        <tbody>
            @php $id = 1; @endphp
            @foreach($salesReturnsItems as $item)
                @foreach ($item->details as $detail)

                <tr>
                    <td>{{ $id++ }}</td>
                    <td>{{ $item->pos_bill_id }}</td>
