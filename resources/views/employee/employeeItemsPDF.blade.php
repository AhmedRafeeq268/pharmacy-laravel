...
<head>
    <meta charset="UTF-8">
    <title>@lang('messages.reports.employee_report')</title>
    <style>
        @font-face {
        font-family: 'Amiri';
...
<body>
    ...
    <table>
        <thead>
            <tr>
                <th>#</th>
                <th>@lang('messages.employee.employee_name')</th>
                <th>@lang('messages.employee.phone_number')</th>
                <th>@lang('messages.employee.email')</th>
                <th>@lang('messages.employee.id_card')</th>
                <th>@lang('messages.created_at')</th>
            </tr>
        </thead>
        <tbody>
            @php $id = 1; @endphp
            @foreach($employeesItems as $item)
                <tr>
                    <td>{{ $id++ }}</td>
                    <td>{{ $item->name }}</td>
                    <td>{{ $item->phone }}</td>
