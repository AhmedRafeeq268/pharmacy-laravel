            ...
            <tr>
                ...
                <td>
                    <div class="d-flex justify-content-center align-items-center gap-2">
                        ...
                        <a href="{{ route('product.edit',['product'=>$product->id ,'page'=>request()->get('page')] ) }}" class="btn btn-primary btn-sm">@lang('messages.edit')</a>

                        <form action="{{ route('product.destroy', ['product'=>$product->id ,'page'=>request()->get('page')]) }}" method="POST" onsubmit="return confirm('@lang('messages.are_you_need_print_bill')')" style="display:inline;">
                            @csrf
                            @method('DELETE')
