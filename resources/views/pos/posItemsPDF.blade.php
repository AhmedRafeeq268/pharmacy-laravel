...
<head>
    <meta charset="UTF-8">
    <title>@lang('messages.reports.pos_report')</title>
    <style>
        @font-face {
        font-family: 'Amiri';
...
<body>
    ...
    <h2>@lang('messages.reports.pos_report')</h2>

    <table>
        <thead>
            <tr>
                <th>#</th>
                <th>@lang('messages.pos.customer_name')</th>
                <th>@lang('messages.pos.employee_name')</th>
                <th>@lang('messages.pos.total_amount')</th>
                <th>@lang('messages.pos.discount')</th>
                <th>@lang('messages.pos.net_amount')</th>
                <th>@lang('messages.pos.payment_status')</th>
