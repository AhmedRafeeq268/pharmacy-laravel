...
<head>
    <meta charset="UTF-8">
    <title>@lang('messages.reports.supplier_report')</title>
    <style>
        @font-face {
        font-family: 'Amiri';
...
<body>
    ...
    <h2>@lang('messages.reports.supplier_report')</h2>
    ...
    <table>
        <thead>
            <tr>
                ...
                <th>@lang('messages.suppliers.phone')</th>
                <th>@lang('messages.suppliers.email')</th>
