...
<head>
    <meta charset="UTF-8">
    <title>@lang('messages.reports.expenses_report')</title>
    <style>
        @font-face {
        font-family: 'Amiri';
...
<body>
    ...
    <h2>@lang('messages.reports.expenses_report')</h2>
    ...
    <table>
        <thead>
            <tr>
                ...
                <th>@lang('messages.expenses.expense_date')</th>
                <th>@lang('messages.expenses.created_by')</th>
